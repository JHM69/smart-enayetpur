      ...
      <div className="flex h-fit w-full flex-col space-y-8 md:w-[60%] lg:w-[70%]">
        <div className="flex flex-col space-y-2">
          <h2 className="text-3xl font-bold text-gray-400">
            {user.role === 'INSTRUCTOR' ? 'Teacher' : 'User'}
          </h2>
        ...
        <div className="flex flex-col space-y-2">
          <h2 className="text-3xl font-bold text-gray-400">Story</h2>
          ...
          <Balancer>
            <article
              ...
              dangerouslySetInnerHTML={{
                __html: user?.bio?.bioDescription || 'Not update',
              }}
            ></article>
          </Balancer>
        </div>
        ...
        <div className="flex flex-col space-y-2">
          <h2 className="text-3xl font-bold text-gray-400">Course</h2>
