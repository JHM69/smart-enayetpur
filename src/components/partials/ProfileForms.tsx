...
import Editor from '../shared/RichEditor';
    ...
    >
      <div className="flex flex-col space-y-10">
        <div className="flex flex-col space-y-4 md:w-3/4">
          <label className="text-3xl">Summary</label>
          {errors.specialist && (
            <span className="flex items-center text-xl italic text-rose-500">
              <ExclamationCircleIcon className="h-6 w-6" />
              Up to 60 characters on ones own
            </span>
          )}
          ...
          <input
            ...
            type="text"
            placeholder="Tell others who are you"
          />
        </div>

        <div className="flex flex-col space-y-4 rounded-xl">
          <label className="text-3xl">About you</label>
          {error.bioError && (
            <span className="flex items-center text-xl italic text-rose-500">
              <ExclamationCircleIcon className="h-6 w-6" /> Biography needs at
              least 20 characters
            </span>
          )}
