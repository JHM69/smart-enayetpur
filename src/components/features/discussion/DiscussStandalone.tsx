    ...
    try {
      ...
      if (inputType === 'discuss') {
        ...
        await axios.post(`/api/notification`, {
          ...
          content: `Có Student thảo luận Cource ${lectureCtx.course?.name} của bạn`,
        });
        return;
      }
      ...
      if (inputType === 'reply') {
        ...
        await axios.post(`/api/notification`, {
          location: router.asPath,
          userId: authorId,
          content: `Someone replied to discuss Courte${lectureCtx.course?.name} của bạn`,
        });
        return;
      }
  ...
  return (
    <div className="flex">
      ...
      <Editor
        ...
        removeMessage={inputType === 'editDiscuss' ? 'Cancel' : undefined}
        key={String(
