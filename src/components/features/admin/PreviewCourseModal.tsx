              ...
              >
                <Dialog.Panel className="flex h-[85vh] w-[60rem] transform flex-col overflow-hidden overflow-y-scroll rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all dark:bg-dark-background md:h-[75vh] lg:h-[90vh]">
                  ...
                  <div className="fex w-full flex-col space-y-6">
                    ...
                    <div className="flex w-full flex-col">
                      <h2 className="font-bold">Instructor ID:</h2>
                      <p>{course?.userId}</p>
                    </div>
                    ...
                    {course &&
                      ...
                      course?.courseRequirements.length > 0 && (
                        <div className="flex w-full flex-col">
                          <h2 className="font-bold">Course requirements:</h2>
                          <ul className="list-inside list-disc">
                    ...
                    <div className="flex w-full flex-col">
                      <h2 className="font-bold">Course price:</h2>
                    ...
                    <div className="flex w-full flex-col">
                      <h2 className="font-bold">Course object:</h2>
                      <p>
                          ...
                          course.chapters.map((chapter) => {
                            return (
                              ...
                              <li key={chapter.id}>
                                {chapter.title}{' '}
                                <span>
                                  (Number of lessons: {chapter.lectures?.length}
                                  ):
                                </span>
                                <ul className="pl-6">
