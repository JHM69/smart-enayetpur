...
function VerifyCourses({
  ...
  useEffect(() => {
    ...
    if (isError) {
      toast.error('Approval failed! Retry!');
    }
  }, [isSuccess, isError]);
        ...
        await Promise.allSettled(
          courses?.map(async (c) => {
            return await axios.post(`/api/notification`, {
              ...
              content: `Course ${c.name} has been approved`,
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="text-center">
                              {course.createdAt.toLocaleDateString('bn-BD')}
                            </td>
                            <td className="text-center">
                              {course.updatedAt.toLocaleDateString('bn-BD')}
                            </td>
