  ...
  return (
    <div className="mt-4 flex flex-col space-y-6">
      ...
      <p className="italic md:w-3/4">
        A course must have at least 1 chapter, 1 lesson and 1 preview lesson
        public. See also section{' '}
        <span className="text-rose-500">instructions</span> for more details!
      </p>
