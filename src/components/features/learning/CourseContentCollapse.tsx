    ...
    <div className="w-full">
      <div className="mx-auto w-full px-2" ref={animationParent}>
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="flex w-full flex-col rounded-xl bg-stone-300 px-4 py-2 text-left text-lg font-medium dark:border-white dark:bg-background_dark md:text-2xl">
                        ...
                        <li
                          onClick={() => {
                            if (
                              ...
                              toast.error(
                                'You have not completed the previous lesson!',
                              );
                              return;
                            }
