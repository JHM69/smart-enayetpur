...
function NoteItem({ note, refetchNotes }: NoteItemProps) {
  ...
  return (
    <li className="flex min-h-[300px] flex-col space-y-4 rounded-xl bg-light-background px-3 py-2 dark:bg-background_dark">
      ...
      <If condition={editable}>
        ...
        <Else>
          <article
            className={`prose-sm prose min-h-[10rem] min-w-full overflow-x-hidden rounded-xl  border border-dashed border-gray-500 px-3 py-2 text-gray-600 lg:prose-xl prose-img:rounded-2xl dark:text-white/80`}
